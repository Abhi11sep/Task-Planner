        ...
        <div>
            ...
            <div id='second'>
                ...
                <h3>Make every day count with our task planner.</h3>
                    <input id='inputing' type="text" placeholder='Enter Your Name' value={name} onChange={(e) => setname(e.target.value)} />

                    <button id='button_login' onClick={submit}>Let's Start</button>
